    ...
    render() {
        ...
        return (
            <View style={[{
                ...
                <View style={[{
                    borderColor: 'white',
                    width: this.props.avatarDimension,
                    height: this.props.avatarDimension,
                    borderWidth: 2,
                    borderRadius: this.props.avatarDimension,
                    alignItems: 'center',
                    justifyContent: 'center',
                    backgroundColor: 'white'
                }]}>
                    <Image style={{width: this.props.avatarDimension, height: this.props.avatarDimension, borderRadius: this.props.avatarDimension}}
                           source={require('../../Assets/images/elon_musk.jpeg')}/>
                </View>
                <Text style={{color: this.props.color, marginLeft: 10, fontSize: 18}}>{this.props.name}</Text>
