            ...
            <View style={styles.container}>
                ...
                <View style={styles.frame} pointerEvents='box-none'>
                    <Interactable.View
                        ...
                        gravityPoints={[{x: 120, y: 200*heightFactor, strength: 8000, falloff: 40, damping: 0.5, haptics: true}]}
                        ...
                        <Animated.View style={[styles.head, {
                            ...
                            <Image style={styles.image} source={require('../../Assets/icons/sendIcon.png')} />
                        </Animated.View>
                    </Interactable.View>
                </View>
                    ...
                    <View style={styles.frame} pointerEvents='box-none'>
                        <Interactable.View
                            ...
                            <Animated.View style={[styles.head, {
                                ...
                                <Image style={styles.image} source={require('../../Assets/icons/iconPlus.png')} />
                            </Animated.View>
                        </Interactable.View>
                    </View>
                }
